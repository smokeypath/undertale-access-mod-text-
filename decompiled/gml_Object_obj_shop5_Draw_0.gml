...
if (menu == 5)
{
    ...
    draw_set_color(c_white);
    var price_width = round(string_width(scr_gettext("shop5_sell_price", "888")));
    var separator = scr_gettext("shop5_sell_separator");
    var sep_width = string_width(separator);
    ...
    for (i = 0; i < 4; i += 1)
    {
        ...
        {
            xx += price_width;
            var value_x = xx - round(string_width(s_value[i * 2]));
        ...
        {
            xx += price_width;
            var value_x = xx - round(string_width(s_value[(i * 2) + 1]));
            draw_text(value_x, yy, s_value[(i * 2) + 1]);
            draw_text(xx, yy, separator);
            xx += sep_width;
            var name = global.itemnameb[(i * 2) + 1];
            var scale = 1;
            var width = string_width(name);
